...
module Phcmembers
  RSpec.describe Members::MainsController, type: :controller do

    # This should return the minimal set of attributes required to create a valid
    # Members::Main. As you add validations to Members::Main, be sure to
    ...
    # Members::MainsController. Be sure to keep this updated too.
    let(:valid_session) { {} }
