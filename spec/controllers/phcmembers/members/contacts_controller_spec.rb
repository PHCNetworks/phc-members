...
module Phcmembers
  RSpec.describe Members::ContactsController, type: :controller do

    # This should return the minimal set of attributes required to create a valid
    # Members::Contact. As you add validations to Members::Contact, be sure to
    ...
    # Members::ContactsController. Be sure to keep this updated too.
    let(:valid_session) { {} }
