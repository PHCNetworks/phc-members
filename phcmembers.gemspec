...
Gem::Specification.new do |spec|
  ...
  spec.summary     = "PHCMembers(9Beta) - Rails Membership Management Engine"
  spec.description = "PHCMembers(9Beta) rails engine to manage membership information and directory listings."
  spec.license     = "MIT"
