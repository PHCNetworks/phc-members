...
Gem::Specification.new do |phc_gem_spec|
  ...
  phc_gem_spec.description = "Ruby on Rails 5.2 Engine to Manage Member Information and Business Directory Listings"
  ...
  phc_gem_spec.add_dependency 'phcaccounts', '~> 35.0'
